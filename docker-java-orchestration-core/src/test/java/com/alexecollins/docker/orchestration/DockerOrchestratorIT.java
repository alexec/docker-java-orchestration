...
public class DockerOrchestratorIT {
    ...
    public void listsAllDefinintions() throws Exception {
        assertEquals(Arrays.asList(new Id("image-name"), new Id("busybox"), new Id("disabled"), new Id("mysql"), new Id("app")), orchestrator.ids());
    }
    ...
    public void whenWeCleanThenOnlyContainersAreDeleted() throws Exception {
        ...
        int expectedImageSize = expectedImages.size() + (runningOnCircleCi() ? 3 : 0) + 1;
